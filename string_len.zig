...
pub fn main() !void {
    ...
    // utf8  Charlen = 13, Bytelen = 13
    // utf16 Charlen = 13, Bytelen = 26
    // utf8  Charlen = 5,  Bytelen = 7
    // utf16 Charlen = 5,  Bytelen = 10
    // utf8  Charlen = 7,  Bytelen = 28
    // utf16 Charlen = 7,  Bytelen = 28
    // utf8  Charlen = 9,  Bytelen = 14
    // utf16 Charlen = 9,  Bytelen = 18
}
